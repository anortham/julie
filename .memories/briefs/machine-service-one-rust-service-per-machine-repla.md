...
updated: 2026-09-11T14:19:02.669Z
tags:
  - machine-service
  - architecture
  - complexity-rule
...
- **Semantic auto backend is complete** on branch `hybrid-auto` in `.worktrees/hybrid-auto`, gates green, finding at `docs/findings/2026-09-11-hybrid-auto-backend.md`. Omitted backend runs semantic for NL queries when vectors are ready. Not merged; main moved after the branch was cut, so the merge needs a merge commit. Owner decides merge.

## Owner's sequence after 6a (set 2026-09-11)

1. **Semantic by default search.** Done, awaiting merge. Auto equals the semantic column: 18/23 top-1, 20/23 top-5, p50 15 ms; scorecard MRR 0.848 vs lexical 0.351.
