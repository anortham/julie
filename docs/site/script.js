  ...
  function runHeroAnimation() {
    ...
    if (prefersReducedMotion()) {
      ...
      reads.innerHTML = [
        ...
        '<div class="file-read-line visible"><span class="julie-cmd">edit_file("src/services/user.rs", old_text, new_text)</span> → <span class="julie-result">Applied · 200 tokens</span></div>',
      ].join('');
    ...
    function startPhase2() {
      ...
      const julieSteps = [
        ...
        { cmd: 'edit_file("src/services/user.rs", old_text, new_text)', result: 'Applied · 200 tokens', tokens: 200 },
      ];
