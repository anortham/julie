...
### Finding #17 🟡 `test_fresh_index_no_reindex_needed` is `#[ignore]`d
...
**Fix:** either seed mtimes explicitly in the test to eliminate clock-drift flakiness, or fix the impl if it's racy. Do not ship with this ignored.
