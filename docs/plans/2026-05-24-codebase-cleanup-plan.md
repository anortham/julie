...
- **Candidate 11:** broad handler/workspace/search/watcher/workspace-pool splits still wait on stronger contracts and harnesses. The next safe daemon DB slice is likely `codehealth`; avoid `migrate_workspace_ids` until table-specific modules exist.
