...
- **Candidate 10:** remaining slice is resolver same-language scoring/content-aware language metadata for relationship candidates, if re-review confirms enough value and test leverage. Do not reintroduce path-only `.h` assumptions.
