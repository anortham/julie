...
- **Candidate 12:** remaining slices are dashboard/analysis/local SQL fixture helpers and larger behavior-file splits after those helpers exist. Do not consolidate daemon roots, adapter duplex tests, or schema/migration raw SQL without per-cluster review.
