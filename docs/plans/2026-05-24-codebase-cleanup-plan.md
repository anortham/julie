...
- **Candidate 11:** broad handler/workspace/search/watcher/workspace-pool splits still wait on stronger contracts and harnesses. The next structural slices should stay private and bounded like daemon DB migrations.
