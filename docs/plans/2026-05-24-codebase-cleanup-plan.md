...
- **Candidate 12:** remaining slices are DB fixture builders and larger behavior-file splits after those builders exist. Do not consolidate daemon roots, adapter duplex tests, or schema/migration raw SQL without per-cluster review.
