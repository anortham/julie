...
**Acceptance criteria:**
- [ ] `.github/scripts/pack-release.sh --dry-run <target>` prints the pinned asset name and sha256 for each of the four targets and exits 0; an unknown target exits 2.
...
- [ ] `release.yml` calls the script for all four matrix targets, has no Python or CUDA text, and parses.
