...
- No `capabilities.json` evidence entry references the deleted `docs/findings/COMPILED-FINDINGS.md`. Every `evidence` field is a typed object, not a string path.
