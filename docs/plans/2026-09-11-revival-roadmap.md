...
**Status:** Plan 1 implemented and verified locally on 2026-09-12 on `fix/revival-correctness`. Plan 2 is approved and in progress on `fix/revival-retrieval`; Plans 3–5 remain proposals. Publication is not authorized.
