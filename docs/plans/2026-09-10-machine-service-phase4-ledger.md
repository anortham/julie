...
| Net lines vs `eacfc98f` | `tokei src crates xtask --exclude 'src/tests' --exclude '*/tests/*' -t Rust` | worker-tokei | 1ba06354 | 101,300 → 98,043 (net −3,257 lines, −2,767 code) | 2026-09-10T22:25:00Z | no |
