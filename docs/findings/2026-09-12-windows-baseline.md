...
At `1d1960bae029af39ede8a6a6775f188045d3b3a6`, the metrics fixture passed in the full run, but the lazy semantic-initialization assertion failed again:1033passed,1failed. The canonical-root change alone did not resolve that failure. Full log: `/home/murphy/.local/share/win-test/logs/20260912T171035Z-revival-retrieval-1790969.log`. An exact Windows rerun reproduced it (0passed/1failed) without suite contention: `/home/murphy/.local/share/win-test/logs/20260912T171312Z-revival-retrieval-1792268.log`. Root-cause diagnosis continues; no Windows full pass is claimed.

At `95ac20ae1611a689b00141e21fd34f733957c288`, the exact lazy-initialization test passes on Windows (1passed,5.318seconds). Capturing the counter key after indexing resolves the active-route rebinding mismatch; capturing it before indexing was insufficient. Log: `/home/murphy/.local/share/win-test/logs/20260912T171443Z-revival-retrieval-1793549.log`.

At `95ac20ae1611a689b00141e21fd34f733957c288`, the full Windows gate passed the metrics and lazy-init checks and reached1148tests:1147passed,1failed. Sibling-worktree seeding returned no seed despite the fixture's existing sibling index. Log: `/home/murphy/.local/share/win-test/logs/20260912T171551Z-revival-retrieval-1794153.log`. Windows seeding identification is under investigation.

At `600c87137b70910b37304143559163c978a3d245`, the exact sibling seeding test passed on native NTFS (1passed,12.339seconds), preserving its copy/re-extraction counts. Log: `/home/murphy/.local/share/win-test/logs/20260912T172353Z-revival-retrieval-1800095.log`. The implementation uses the existing URL library to encode the native absolute SQLite attachment path with read-only mode. No new dependency was added.

At `600c87137b70910b37304143559163c978a3d245`, the full Windows gate passed1778tests before a runtime home-symlink fixture failed its raw-HOME guard assertion. The fixture's home-environment assumption is under correction. Log: `/home/murphy/.local/share/win-test/logs/20260912T172549Z-revival-retrieval-1800990.log`. All earlier retrieval, seeding, metrics and service failure points passed in this run.

At `7ffb663740413a767429023c7cd8731d63f980d5`, the exact native-home/canonical-path guard passed on Windows (1passed). Log: `/home/murphy/.local/share/win-test/logs/20260912T173135Z-revival-retrieval-1805498.log`. This command built a separate crate-specific dependency feature set in2m39s; the test itself took0.012seconds.

At `7ffb663740413a767429023c7cd8731d63f980d5`, the full gate ran249tests:248passed,1failed. The strengthened metrics fixture now exposes the earlier empty graph's cause: index_tool returned an embedded error because Tantivy could not open a generated `.idx` file for writing (Windows PermissionDenied, error5). Log: `/home/murphy/.local/share/win-test/logs/20260912T173452Z-revival-retrieval-1806923.log`. This is an indexing I/O failure, not a metrics count bug or successful empty index; file-handle/index lifecycle diagnosis continues.

At `0751412606b67f47098e9848f529988fec11f3aa`, the instrumented metrics group passed11/11, then a bounded ten-run series passed110/110 with no recurrence. Logs: `/home/murphy/.local/share/win-test/logs/20260912T173900Z-revival-retrieval-1809458.log` and `/home/murphy/.local/share/win-test/logs/20260912T174046Z-revival-retrieval-1810340.log`. Failed index fixtures are now preserved with path/state diagnostics. The I/O cause is still unproven; these passes are diagnostic evidence, not a claimed product fix.

The full Windows run at `0751412606b67f47098e9848f529988fec11f3aa` completed937tests:936passed,1failed at a file-search execution-trace assertion. It did not reproduce the instrumented metrics I/O failure. Log: `/home/murphy/.local/share/win-test/logs/20260912T174218Z-revival-retrieval-1810956.log`. Search-trace fixture identity and embedded tool errors are under diagnosis.

At `199f3078ecf31214d43d233291d473b2e4116d32`, the exact hidden-directory ranking test passed on Windows (1passed,0.766seconds). The fixture now has an explicit workspace marker and verifies canonical root identity, preventing ancestor-checkout binding from win-test's nested TEMP path. Log: `/home/murphy/.local/share/win-test/logs/20260912T174838Z-revival-retrieval-1814790.log`.

At `199f3078ecf31214d43d233291d473b2e4116d32`, the full gate again failed during fixture indexing, preserving `C:/Users/agent/AppData/Local/Temp/.tmpoU8Xpb`. Log: `/home/murphy/.local/share/win-test/logs/20260912T175026Z-revival-retrieval-1815572.log`. Its source exists (48bytes), facts contain one blob, and the failed new segment `.pos` file is absent while other new segment files exist. Directory creation time is unchanged and ACL grants agent full control. Inventory/ACL logs: `20260912T175141Z-revival-retrieval-1816153.log` and `20260912T175235Z-revival-retrieval-1816452.log` under the win-test log directory. No matching Defender event was found; enabled protection alone is not causal evidence.

Thirty serial Windows runs of the lower-level `apply_three_files_publishes_graph_symbols_and_searchable_names` test passed, without the handler/watcher. Log: `/home/murphy/.local/share/win-test/logs/20260912T175512Z-revival-retrieval-1817640.log`. A first command used an over-exact filter and ran zero tests; it is not included in that pass count. Concurrent independent-store isolation is the next diagnostic.
