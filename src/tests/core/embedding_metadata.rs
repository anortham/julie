...
mod tests {
    ...
    fn test_prepare_batch_empty_input() {
        let batch = prepare_batch_for_embedding(&[], None, &HashMap::new(), &HashMap::new(), &HashMap::new());
...
// Variable budget, test exclusion, callee/field enrichment, and extract_doc_excerpt
// tests moved to embedding_metadata_enrichment.rs to stay under the 1000-line limit.
