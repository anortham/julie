...
//
// Further handler-free tests relocated to crates/julie-tools/src/tests/ (T2b.6):
// annotation_search_tests, lean_format_tests, line_match_strategy_tests,
// nl_path_prior_pipeline_tests, nl_symbol_query_latency_tests, pretokenized_emit_test,
// promotion_tests, tantivy_index_tests, tantivy_integration_tests,
// tantivy_path_prior_tests, title_exact_boost_tests, zero_hit_reason_tests.
