...
pub(crate) fn fast_search_metadata(
    ...
    let trace = execution.map(|result| {
        ...
        json!({
            ...
            "line_enrichment_status": result.trace.line_enrichment_status,
            "line_enrichment_match_count": result.trace.line_enrichment_match_count,
            "line_enrichment_zero_hit_reason": result.trace.line_enrichment_zero_hit_reason,
            "line_enrichment_file_pattern_diagnostic": result.trace.line_enrichment_file_pattern_diagnostic,
            "line_enrichment_error": result.trace.line_enrichment_error,
