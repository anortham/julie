...
|-----------|----------|-------|----------|----------|-------------|------|-----------|----------|
| jq_13566b9e | c | 12361 | 1932 | 15.6% | 30.6% | 1742 | 1195 | 271 |
| nlohmann-json_a5f86cd4 | cpp | 15411 | 3872 | 25.1% | 26.2% | 4325 | 3332 | 361 |
| newtonsoft_json_afe705a1 | csharp | 21062 | 10710 | 50.8% | 48.7% | 0 | 934 | 3999 |
| riverpod_a7fdc041 | dart | 28289 | 13314 | 47.1% | 66.4% | 0 | 525 | 1750 |
| phoenix_ac16deb4 | elixir | 15907 | 6219 | 39.1% | 87.0% | 0 | 0 | 47 |
| cobra_8b201fd3 | go | 1441 | 778 | 54.0% | 54.8% | 114 | 57 | 174 |
| guava_7e9af99a | java | 125984 | 67051 | 53.2% | 53.1% | 0 | 7814 | 12797 |
| express_8cefd559 | javascript | 5384 | 2998 | 55.7% | 49.6% | 1495 | 0 | 695 |
| moshi_c9c5a600 | kotlin | 6603 | 2597 | 39.3% | 29.7% | 0 | 67 | 2279 |
| lite_f7e95a20 | lua | 27858 | 8559 | 30.7% | 20.2% | 742 | 0 | 268 |
| slim_dce0015d | php | 4031 | 1150 | 28.5% | 25.2% | 2025 | 50 | 222 |
| flask_9045020a | python | 4291 | 1917 | 44.7% | 41.8% | 1387 | 40 | 144 |
| sinatra_86eed2fe | ruby | 4290 | 1460 | 34.0% | 32.0% | 2155 | 184 | 25 |
| julie_316c0b08 | rust | 34262 | 24309 | 71.0% | 82.4% | 0 | 193 | 969 |
| cats_c701f713 | scala | 22336 | 15173 | 67.9% | 69.0% | 149 | 4009 | 0 |
| alamofire_3d4cceb5 | swift | 20555 | 3880 | 18.9% | 31.2% | 0 | 134 | 5142 |
| labhandbookv2_67e8c1cf | typescript | 7306 | 2584 | 35.4% | 25.5% | 1511 | 51 | 383 |
| zod_df52de88 | typescript | 17055 | 5931 | 34.8% | 31.8% | 5533 | 1729 | 2329 |
| zls_4b29ec8b | zig | 10677 | 2562 | 24.0% | 20.9% | 1726 | 4394 | 1533 |
...
| cobra_8b201fd3 | go | 5/5 | 0.82 | 0.42 | 0.0 | no |
...
- **Avg diversity (cross-file):** 0.683
- **Avg namespace overlap:** 0.409
- **Avg same-kind ratio:** 0.828
...
| 6 | 0.860 | `GLfloat` | type | `...10/i686-w64-mingw32/include/SDL2/SDL_opengles2_gl2.h` |
| 7 | 0.860 | `GLfloat` | type | `.../x86_64-w64-mingw32/include/SDL2/SDL_opengles2_gl2.h` |
| 8 | 0.858 | `GLbyte` | type | `...10/i686-w64-mingw32/include/SDL2/SDL_opengles2_gl2.h` |
| 9 | 0.858 | `GLbyte` | type | `.../x86_64-w64-mingw32/include/SDL2/SDL_opengles2_gl2.h` |
| 10 | 0.855 | `GLfixed` | type | `...10/i686-w64-mingw32/include/SDL2/SDL_opengles2_gl2.h` |
...
| 4 | 0.812 | `jinja_environment` | variable | `tests/test_templating.py` |
| 5 | 0.811 | `test_custom_jinja_env` | function | `tests/test_templating.py` |
| 6 | 0.792 | `Environment` | class | `src/flask/templating.py` |
| 7 | 0.778 | `create_jinja_environment` | method | `src/flask/app.py` |
| 8 | 0.750 | `App` | class | `src/flask/sansio/app.py` |
| 9 | 0.743 | `from_prefixed_env` | method | `src/flask/config.py` |
| 10 | 0.740 | `create_global_jinja_loader` | method | `tests/test_templating.py` |

Quality: diversity=0.7, same_kind=0.5, ns_overlap=0.0, unique_files=6
...
| 4 | 0.716 | `response` | variable | `test/static_test.rb` |
| 5 | 0.715 | `get_response` | method | `sinatra-contrib/lib/sinatra/runner.rb` |
| 6 | 0.705 | `response` | variable | `test/helpers_test.rb` |
| 7 | 0.704 | `escape_url` | method | `rack-protection/lib/rack/protection/escaped_params.rb` |
| 8 | 0.703 | `tell` | method | `sinatra-contrib/lib/sinatra/streaming.rb` |
| 9 | 0.703 | `http_status` | method | `test/mapped_error_test.rb` |
| 10 | 0.703 | `http_status` | method | `test/result_test.rb` |

Quality: diversity=0.7, same_kind=0.8, ns_overlap=0.0, unique_files=8
...
**Pivot:** `new` (method, rust, refs=3194)  
