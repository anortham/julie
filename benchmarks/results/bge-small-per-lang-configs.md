...
|-----------|----------|-------|----------|----------|-------------|------|-----------|----------|
| jq_13566b9e | c | 12361 | 2428 | 19.6% | 30.6% | 1742 | 1195 | 271 |
| nlohmann-json_a5f86cd4 | cpp | 15411 | 2408 | 15.6% | 26.2% | 4325 | 3332 | 361 |
| newtonsoft_json_afe705a1 | csharp | 21062 | 3790 | 18.0% | 48.7% | 0 | 934 | 3999 |
| riverpod_a7fdc041 | dart | 28289 | 6393 | 22.6% | 66.4% | 0 | 525 | 1750 |
| phoenix_ac16deb4 | elixir | 15907 | 3830 | 24.1% | 87.0% | 0 | 0 | 47 |
| cobra_8b201fd3 | go | 1441 | 404 | 28.0% | 54.8% | 114 | 57 | 174 |
| guava_7e9af99a | java | 125984 | 39950 | 31.7% | 53.1% | 0 | 7814 | 12797 |
| express_8cefd559 | javascript | 5384 | 484 | 9.0% | 49.6% | 1495 | 0 | 695 |
| moshi_c9c5a600 | kotlin | 6603 | 1032 | 15.6% | 29.7% | 0 | 67 | 2279 |
| lite_f7e95a20 | lua | 27858 | 9239 | 33.2% | 20.2% | 742 | 0 | 268 |
| slim_dce0015d | php | 4031 | 804 | 19.9% | 25.2% | 2025 | 50 | 222 |
| flask_9045020a | python | 4291 | 710 | 16.5% | 41.8% | 1387 | 40 | 144 |
| sinatra_86eed2fe | ruby | 4290 | 1337 | 31.2% | 32.0% | 2155 | 184 | 25 |
| julie_316c0b08 | rust | 54104 | 8737 | 16.1% | 82.4% | 0 | 193 | 972 |
| cats_c701f713 | scala | 22336 | 13769 | 61.6% | 69.0% | 149 | 4009 | 0 |
| alamofire_3d4cceb5 | swift | 20555 | 3293 | 16.0% | 31.2% | 0 | 134 | 5142 |
| labhandbookv2_67e8c1cf | typescript | 7306 | 1471 | 20.1% | 25.5% | 1511 | 51 | 383 |
| zod_df52de88 | typescript | 17055 | 6950 | 40.8% | 31.8% | 5533 | 1729 | 2329 |
| zls_4b29ec8b | zig | 10677 | 2029 | 19.0% | 20.9% | 1726 | 4394 | 1533 |
...
| nlohmann-json_a5f86cd4 | cpp | 5/5 | 0.914 | 0.5 | 0.28 | no |
...
| cobra_8b201fd3 | go | 5/5 | 0.812 | 0.38 | 0.0 | no |
| guava_7e9af99a | java | 5/5 | 1.0 | 0.44 | 0.78 | no |
| express_8cefd559 | javascript | 5/5 | 0.951 | 0.56 | 0.22 | no |
| moshi_c9c5a600 | kotlin | 5/5 | 0.937 | 0.88 | 0.84 | yes |
| lite_f7e95a20 | lua | 5/5 | 1.0 | 0.7 | 0.34 | no |
| slim_dce0015d | php | 5/5 | 0.974 | 0.8 | 0.6 | no |
| flask_9045020a | python | 5/5 | 0.871 | 0.48 | 0.0 | no |
| sinatra_86eed2fe | ruby | 5/5 | 0.907 | 0.46 | 0.16 | no |
...
| labhandbookv2_67e8c1cf | typescript | 5/5 | 0.907 | 0.68 | 0.34 | yes |
...
- **Avg mean similarity:** 0.85
- **Avg diversity (cross-file):** 0.642
- **Avg namespace overlap:** 0.354
- **Avg same-kind ratio:** 0.825
...
| 3 | 0.836 | `len` | variable | `include/nlohmann/detail/output/binary_writer.hpp` |
| 4 | 0.835 | `calc_bson_element_size` | method | `include/nlohmann/detail/output/binary_writer.hpp` |
| 5 | 0.834 | `calc_bson_string_size` | method | `include/nlohmann/detail/output/binary_writer.hpp` |
| 6 | 0.833 | `calc_bson_integer_size` | method | `include/nlohmann/detail/output/binary_writer.hpp` |
| 7 | 0.832 | `size` | variable | `include/nlohmann/detail/input/binary_reader.hpp` |
| 8 | 0.828 | `size_and_type` | variable | `include/nlohmann/detail/input/binary_reader.hpp` |
| 9 | 0.828 | `size_and_type` | variable | `include/nlohmann/detail/input/binary_reader.hpp` |
| 10 | 0.828 | `size_and_type` | variable | `include/nlohmann/detail/input/binary_reader.hpp` |

Quality: diversity=1.0, same_kind=0.4, ns_overlap=0.1, unique_files=3
...
| 6 | 0.792 | `JsonSchemaNode` | constructor | `Src/Newtonsoft.Json/Schema/JsonSchemaNode.cs` |
| 7 | 0.792 | `TraceJsonReader` | constructor | `Src/Newtonsoft.Json/Serialization/TraceJsonReader.cs` |
| 8 | 0.791 | `MapType` | method | `Src/Newtonsoft.Json/Schema/JsonSchemaBuilder.cs` |
| 9 | 0.789 | `Combine` | method | `Src/Newtonsoft.Json/Schema/JsonSchemaNode.cs` |
| 10 | 0.788 | `JsonSchemaException` | constructor | `Src/Newtonsoft.Json/Schema/JsonSchemaException.cs` |

Quality: diversity=0.8, same_kind=0.4, ns_overlap=0.2, unique_files=6
...
| 2 | 1.000 | `Read` | method | `Src/Newtonsoft.Json/JsonValidatingReader.cs` |
| 3 | 1.000 | `Read` | method | `Src/Newtonsoft.Json/JsonTextReader.cs` |
...
| 7 | 0.740 | `get` | method | `...-plugin-content-docs/current/about_codegen/main.dart` |
| 8 | 0.740 | `get` | method | `...s-plugin-content-docs/current/about_codegen/raw.dart` |
...
| 8 | 0.768 | `get` | method | `...-plugin-content-docs/current/about_codegen/main.dart` |
| 9 | 0.768 | `get` | method | `...s-plugin-content-docs/current/about_codegen/raw.dart` |
...
| 5 | 0.795 | `flags` | variable | `command.go` |
| 6 | 0.791 | `MarkFlagsRequiredTogether` | method | `flag_groups.go` |
| 7 | 0.788 | `FlagErrorFunc` | method | `command.go` |
| 8 | 0.788 | `ArgsLenAtDash` | method | `command.go` |
| 9 | 0.787 | `PersistentFlags` | method | `command.go` |
| 10 | 0.782 | `InheritedFlags` | method | `command.go` |
...
| 3 | 0.795 | `err` | variable | `completions.go` |
| 4 | 0.778 | `SetFlagErrorFunc` | method | `command.go` |
| 5 | 0.777 | `ValidateArgs` | method | `command.go` |
| 6 | 0.772 | `ErrOrStderr` | method | `command.go` |
| 7 | 0.772 | `flagCompError` | class | `completions.go` |
| 8 | 0.755 | `CompError` | function | `completions.go` |
| 9 | 0.748 | `Execute` | method | `command.go` |
| 10 | 0.744 | `ValidateRequiredFlags` | method | `command.go` |

Quality: diversity=0.7, same_kind=0.7, ns_overlap=0.0, unique_files=2
...
| 8 | 0.738 | `app` | variable | `lib/response.js` |
| 9 | 0.738 | `app` | variable | `lib/response.js` |
| 10 | 0.738 | `app` | variable | `lib/response.js` |
...
| 4 | 0.865 | `GLboolean` | type | `.../x86_64-w64-mingw32/include/SDL2/SDL_opengles2_gl2.h` |
| 5 | 0.865 | `GLboolean` | type | `...10/i686-w64-mingw32/include/SDL2/SDL_opengles2_gl2.h` |
| 6 | 0.863 | `GLclampf` | type | `.../x86_64-w64-mingw32/include/SDL2/SDL_opengles2_gl2.h` |
| 7 | 0.863 | `GLclampf` | type | `...10/i686-w64-mingw32/include/SDL2/SDL_opengles2_gl2.h` |
| 8 | 0.861 | `GLfixed` | type | `...10/i686-w64-mingw32/include/SDL2/SDL_opengles2_gl2.h` |
| 9 | 0.861 | `GLfixed` | type | `.../x86_64-w64-mingw32/include/SDL2/SDL_opengles2_gl2.h` |
...
| 2 | 0.827 | `jinja_environment` | variable | `src/flask/sansio/app.py` |
| 3 | 0.819 | `create_jinja_environment` | method | `src/flask/sansio/app.py` |
...
| 8 | 0.738 | `get_source` | method | `src/flask/templating.py` |
| 9 | 0.730 | `create_global_jinja_loader` | method | `src/flask/sansio/app.py` |
| 10 | 0.716 | `from_envvar` | method | `src/flask/config.py` |

Quality: diversity=0.6, same_kind=0.7, ns_overlap=0.0, unique_files=5
...
| 7 | 0.799 | `get_was` | variable | `rack-protection/lib/rack/protection/escaped_params.rb` |
| 8 | 0.794 | `post` | method | `lib/sinatra/base.rb` |
| 9 | 0.793 | `get` | method | `sinatra-contrib/lib/sinatra/multi_route.rb` |
| 10 | 0.787 | `patch` | method | `lib/sinatra/base.rb` |

Quality: diversity=0.3, same_kind=0.9, ns_overlap=0.2, unique_files=4
...
| 6 | 0.773 | `get_was` | variable | `rack-protection/lib/rack/protection/escaped_params.rb` |
| 7 | 0.762 | `link` | method | `sinatra-contrib/lib/sinatra/link_header.rb` |
| 8 | 0.749 | `get` | method | `sinatra-contrib/lib/sinatra/multi_route.rb` |
| 9 | 0.743 | `link?` | method | `lib/sinatra/base.rb` |
| 10 | 0.741 | `inspect` | method | `lib/sinatra/base.rb` |

Quality: diversity=0.6, same_kind=0.9, ns_overlap=0.2, unique_files=5
...
| 2 | 0.737 | `response['Location']` | variable | `lib/sinatra/base.rb` |
| 3 | 0.726 | `status` | method | `lib/sinatra/base.rb` |
| 4 | 0.725 | `with_params` | method | `lib/sinatra/base.rb` |
| 5 | 0.715 | `get_response` | method | `sinatra-contrib/lib/sinatra/runner.rb` |
| 6 | 0.704 | `escape_url` | method | `rack-protection/lib/rack/protection/escaped_params.rb` |
| 7 | 0.703 | `tell` | method | `sinatra-contrib/lib/sinatra/streaming.rb` |
| 8 | 0.701 | `response['Cache-Control']` | variable | `lib/sinatra/base.rb` |
| 9 | 0.700 | `response.status` | variable | `lib/sinatra/base.rb` |
| 10 | 0.699 | `errback` | method | `lib/sinatra/base.rb` |

Quality: diversity=0.3, same_kind=0.7, ns_overlap=0.0, unique_files=4
...
**Pivot:** `new` (method, rust, refs=3197)  
...
| 7 | 0.778 | `new` | method | `crates/julie-extractors/src/bash/mod.rs` |
| 8 | 0.778 | `new` | method | `crates/julie-extractors/src/css/mod.rs` |
| 9 | 0.778 | `new` | method | `crates/julie-extractors/src/dart/mod.rs` |
| 10 | 0.778 | `new` | method | `crates/julie-extractors/src/elixir/mod.rs` |
...
| 8 | 0.747 | `new` | method | `crates/julie-extractors/src/bash/mod.rs` |
| 9 | 0.747 | `new` | method | `crates/julie-extractors/src/css/mod.rs` |
| 10 | 0.747 | `new` | method | `crates/julie-extractors/src/dart/mod.rs` |
...
| # | Sim | Name | Kind | File |
|---|-----|------|------|------|
| 1 | 1.000 | `new` | method | `crates/julie-extractors/src/manager.rs` |
| 2 | 1.000 | `new` | method | `src/tools/metrics/session.rs` |
| 3 | 1.000 | `new` | method | `src/tools/workspace/parser_pool.rs` |
...
| 10 | 0.898 | `new` | method | `crates/julie-extractors/src/bash/mod.rs` |
...
| 7 | 0.933 | `map` | method | `alleycats-core/src/main/scala/alleycats/Extract.scala` |
| 8 | 0.933 | `map` | method | `core/src/main/scala/cats/Parallel.scala` |
| 9 | 0.933 | `map` | method | `core/src/main/scala/cats/Representable.scala` |
...
| 8 | 0.789 | `ApiResponse` | export | `src/LabHandbook.Api/ClientApp/src/types/api.ts` |
...
Quality: diversity=0.4, same_kind=0.4, ns_overlap=0.1, unique_files=3
...
| 7 | 0.829 | `SectionDto` | export | `src/LabHandbook.Api/ClientApp/src/types/pages.ts` |
| 8 | 0.824 | `handleDelete` | function | `....Api/ClientApp/src/components/admin/SectionAdmin.vue` |
| 9 | 0.822 | `SectionMappingExtensions` | class | `...dbook.Api/Models/Mapping/SectionMappingExtensions.cs` |
| 10 | 0.813 | `ToDto` | method | `...book.Api/Models/Mapping/CalendarMappingExtensions.cs` |
...
| 3 | 0.855 | `PageLinkDto` | export | `src/LabHandbook.Api/ClientApp/src/types/pages.ts` |
| 4 | 0.848 | `ToDto` | method | `...dbook.Api/Models/Mapping/SectionMappingExtensions.cs` |
| 5 | 0.817 | `PageLinkDto` | class | `src/LabHandbook.Api/Models/Dto/PageLinkDto.cs` |
| 6 | 0.808 | `PageLinkReorderDto` | export | `src/LabHandbook.Api/ClientApp/src/types/pages.ts` |
...
| 9 | 0.806 | `PageDto` | export | `src/LabHandbook.Api/ClientApp/src/types/pages.ts` |
| 10 | 0.802 | `PageLinkDto` | interface | `src/LabHandbook.Api/ClientApp/src/types/pages.ts` |

Quality: diversity=0.9, same_kind=0.5, ns_overlap=0.5, unique_files=7
...
| 5 | 0.801 | `MediaFileDto` | export | `src/LabHandbook.Api/ClientApp/src/types/media.ts` |
| 6 | 0.799 | `onEditFile` | function | `...ok.Api/ClientApp/src/components/admin/MediaAdmin.vue` |
| 7 | 0.786 | `ToDto` | method | `...Handbook.Api/Models/Mapping/PageMappingExtensions.cs` |
| 8 | 0.780 | `ToDto` | method | `...dbook.Api/Models/Mapping/SectionMappingExtensions.cs` |
| 9 | 0.776 | `MediaFile` | class | `src/LabHandbook.Api/Models/Domain/MediaFile.cs` |
| 10 | 0.767 | `ToDto` | method | `...Handbook.Api/Models/Mapping/UserMappingExtensions.cs` |

Quality: diversity=0.9, same_kind=0.4, ns_overlap=0.4, unique_files=9
...
| 5 | 0.801 | `get` | method | `packages/zod/src/v4/core/util.ts` |
| 6 | 0.801 | `get` | method | `packages/zod/src/v4/classic/schemas.ts` |
...
| 3 | 0.797 | `ParsePayload` | export | `packages/zod/src/v4/core/schemas.ts` |
| 4 | 0.787 | `ParsePayload` | interface | `packages/zod/src/v4/core/schemas.ts` |
| 5 | 0.772 | `handleTupleResult` | function | `packages/zod/src/v4/core/schemas.ts` |
| 6 | 0.771 | `handleReadonlyResult` | function | `packages/zod/src/v4/core/schemas.ts` |
...
| 10 | 0.761 | `_parse` | method | `packages/zod/src/v3/types.ts` |
