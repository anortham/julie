    ...
    BTreeMap::from([
        ...
        (
            ...
            ExpectedBucket {
                ...
                timeout_seconds: 30,
                commands: &[
                    "cargo nextest run -p julie-core --lib tests::database -- --skip search_quality",
                ],
            },
        ),
        (
        ...
        (
            ...
            ExpectedBucket {
                ...
                commands: &[
                    ...
                    "cargo nextest run -p julie-core --lib tests::database_lightweight_query -- --skip search_quality",
                    ...
                    "cargo nextest run -p julie-core --lib tests::memory_vectors -- --skip search_quality",
                    "cargo nextest run --lib tests::core::paths -- --skip search_quality",
                    "cargo nextest run -p julie-core --lib tests::vector_storage -- --skip search_quality",
                ],
            },
        ),
        (
