    ...
    BTreeMap::from([
        ...
        (
            ...
            vec![
                ...
                "tools-get-context-graph".to_string(),
                "tools-search-tantivy".to_string(),
                "tools-search-line-core".to_string(),
                "tools-search-line-filters".to_string(),
                "tools-search-line-primary".to_string(),
                ...
                "tools-workspace-discovery".to_string(),
                "tools-workspace-indexing".to_string(),
                "tools-workspace-management".to_string(),
                ...
                "tools-dogfood-repo-index".to_string(),
                "search-quality".to_string(),
                "extractor-dep-integration".to_string(),
            ],
        ),
        (
            "nano".to_string(),
