...
impl SymbolDatabase {
    ...
    pub(super) fn migration_001_initial_schema(&self) -> Result<()> {
    ...
    pub(super) fn migration_002_add_content_column(&mut self) -> Result<()> {
    ...
    pub(super) fn migration_003_add_relationship_location(&mut self) -> Result<()> {
    ...
    pub(super) fn migration_004_add_content_type(&mut self) -> Result<()> {
    ...
    pub(super) fn migration_005_add_fts_prefix_indexes(&mut self) -> Result<()> {
    ...
    pub(super) fn migration_006_add_types_table(&self) -> Result<()> {
    ...
    pub(super) fn migration_007_drop_fts5(&self) -> Result<()> {
    ...
    pub(super) fn migration_008_drop_embedding_tables(&self) -> Result<()> {
