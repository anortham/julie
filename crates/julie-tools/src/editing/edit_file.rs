...
#[cfg(any(test, feature = "test-support"))]
pub fn clear_before_commit_hook_for_test() {
    *BEFORE_COMMIT_HOOK
        .lock()
...
impl EditFileTool {
    ...
    pub fn base_metrics_metadata(&self) -> Value {
    ...
    pub async fn prepare_edit(&self, handler: &dyn ToolContext) -> Result<PreparedEdit> {
    ...
    pub fn success_metrics_metadata_from_prepared(&self, prepared: &PreparedEdit) -> Value {
    ...
    pub fn call_prepared(&self, prepared: PreparedEdit) -> Result<CallToolResult> {
...
pub fn changed_region_bytes(original: &str, modified: &str) -> usize {
