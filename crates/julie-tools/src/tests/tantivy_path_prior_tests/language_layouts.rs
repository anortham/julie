...
fn test_csharp_project_layout() {
    ...
    julie_index::search::scoring::apply_nl_path_prior(&mut results, "user service");
...
fn test_python_project_layout() {
    ...
    julie_index::search::scoring::apply_nl_path_prior(&mut results, "authentication logic");
...
fn test_java_project_layout() {
    ...
    julie_index::search::scoring::apply_nl_path_prior(&mut results, "service implementation");
...
fn test_go_project_layout() {
    ...
    julie_index::search::scoring::apply_nl_path_prior(&mut results, "authentication handler");
...
fn test_javascript_typescript_project_layout() {
    ...
    julie_index::search::scoring::apply_nl_path_prior(&mut results, "authentication component");
...
fn test_ruby_project_layout() {
    ...
    julie_index::search::scoring::apply_nl_path_prior(&mut results, "authentication module");
...
fn test_generic_docs_penalization() {
    ...
    julie_index::search::scoring::apply_nl_path_prior(&mut results, "engine architecture");
...
fn test_generic_fixtures_penalization() {
    ...
    julie_index::search::scoring::apply_nl_path_prior(&mut results, "json parsing");
