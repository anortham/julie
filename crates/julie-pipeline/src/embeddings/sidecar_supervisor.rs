...
pub const SIDECAR_ROOT_ENV: &str = "JULIE_EMBEDDING_SIDECAR_ROOT";
...
pub const INSTALL_MARKER_VERSION: &str = "v11-gpu-torch";
/// PyTorch publishes wheels for these minor versions (3.10 through 3.13).
pub const SUPPORTED_PYTHON_MINORS: [u32; 4] = [12, 13, 11, 10];
pub const RUNTIME_EDITABLE_REQUIREMENT: &str = ".[runtime]";
...
pub fn managed_cache_base_dir() -> PathBuf {
...
pub fn build_program_override_launch_config(
    program: PathBuf,
...
pub fn python_version_from_program(program: &std::ffi::OsStr) -> Option<(u32, u32)> {
...
pub fn python_version_from_command(
...
pub fn install_marker_value(sidecar_root: &Path) -> String {
    format!(
        "version={}\nroot={}\n",
