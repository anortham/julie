...
pub fn extract_symbols_and_relationships(
    ...
    match language {
        ...
        "rust" => {
            let mut ext = crate::rust::RustExtractor::new(
                language.to_string(),
                file_path.to_string(),
                content.to_string(),
                workspace_root,
        ...
        "python" => {
            let mut ext = crate::python::PythonExtractor::new(
                file_path.to_string(),
                content.to_string(),
                workspace_root,
            );
        ...
        "go" => {
            let mut ext = crate::go::GoExtractor::new(
                language.to_string(),
                file_path.to_string(),
                content.to_string(),
                workspace_root,
        ...
        "c" => {
            let mut ext = crate::c::CExtractor::new(
                language.to_string(),
                file_path.to_string(),
                content.to_string(),
                workspace_root,
        ...
        "cpp" => {
            let mut ext = crate::cpp::CppExtractor::new(
                file_path.to_string(),
                content.to_string(),
                workspace_root,
            );
            ...
            Ok(ExtractionResults {
                ...
                pending_relationships: pending,
                identifiers,
                types: convert_types_map(types, "cpp"),
            })
        }
        "powershell" => {
        ...
        "zig" => {
            let mut ext = crate::zig::ZigExtractor::new(
                language.to_string(),
                file_path.to_string(),
                content.to_string(),
                workspace_root,
        ...
        "razor" => {
            let mut ext = crate::razor::RazorExtractor::new(
                language.to_string(),
                file_path.to_string(),
                content.to_string(),
                workspace_root,
        ...
        "regex" => {
            let mut ext = crate::regex::RegexExtractor::new(
                language.to_string(),
                file_path.to_string(),
                content.to_string(),
                workspace_root,
        ...
        "gdscript" => {
            let mut ext = crate::gdscript::GDScriptExtractor::new(
                language.to_string(),
                file_path.to_string(),
                content.to_string(),
                workspace_root,
        ...
        "css" => {
            let mut ext = crate::css::CSSExtractor::new(
                language.to_string(),
                file_path.to_string(),
                content.to_string(),
                workspace_root,
        ...
        "markdown" => {
            let mut ext = crate::markdown::MarkdownExtractor::new(
                language.to_string(),
                file_path.to_string(),
                content.to_string(),
                workspace_root,
        ...
        "yaml" => {
            let mut ext = crate::yaml::YamlExtractor::new(
                language.to_string(),
                file_path.to_string(),
                content.to_string(),
                workspace_root,
