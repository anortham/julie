...
fn test_is_test_symbol_dispatch_across_languages() {
    ...
    let cases: Vec<Case> = vec![
        ...
        (
            "rust", "test_add", "src/tests/math.rs", SymbolKind::Function,
            vec![], vec![s("test")], None, true,
        ),
        (
            "rust", "test_async", "src/lib.rs", SymbolKind::Function,
            vec![], vec![s("tokio::test")], None, true,
        ),
        // Rust: test_ prefix WITHOUT #[test] attr → false (Rust is attribute-only)
        (
            "rust", "test_something", "src/tests/foo.rs", SymbolKind::Function,
            vec![], vec![], None, false,
        ),
        // Rust: regular function
        (
            "rust", "process_data", "src/lib.rs", SymbolKind::Function,
            vec![], vec![], None, false,
        ),

        // --- Python: decorator or name prefix (no path guard) ---
        (
            "python", "test_login", "tests/test_auth.py", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        // Python: test_ prefix works even in non-test path (no path guard in detect_python)
        (
            "python", "test_login", "src/auth.py", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        // Python: pytest decorator
        (
            "python", "some_check", "tests/test_auth.py", SymbolKind::Function,
            vec![s("pytest.mark.parametrize")], vec![], None, true,
        ),
        // Python: setUp lifecycle method
        (
            "python", "setUp", "tests/test_foo.py", SymbolKind::Method,
            vec![], vec![], None, true,
        ),
        // Python: regular function
        (
            "python", "login", "src/auth.py", SymbolKind::Function,
            vec![], vec![], None, false,
        ),

        // --- Java: @Test decorator ---
        (
            "java", "shouldReturnTrue", "src/test/java/FooTest.java", SymbolKind::Method,
            vec![s("Test")], vec![], None, true,
        ),
        // Java: @BeforeEach lifecycle
        (
            "java", "init", "src/test/java/FooTest.java", SymbolKind::Method,
            vec![s("BeforeEach")], vec![], None, true,
        ),
        // Java: no annotation → false
        (
            "java", "processOrder", "src/main/java/Order.java", SymbolKind::Method,
            vec![], vec![], None, false,
        ),

        // --- Kotlin: shares java/kotlin detector ---
        (
            "kotlin", "shouldReturnUser", "src/test/kotlin/UserTest.kt", SymbolKind::Method,
            vec![s("Test")], vec![], None, true,
        ),
        (
            "kotlin", "fetchUser", "src/main/kotlin/User.kt", SymbolKind::Method,
            vec![], vec![], None, false,
        ),

        // --- Scala: JUnit @Test OR test path OR test name prefix ---
        (
            "scala", "shouldCompute", "src/test/scala/MathSpec.scala", SymbolKind::Method,
            vec![s("Test")], vec![], None, true,
        ),
        // Scala: in test path (no annotation needed)
        (
            "scala", "compute", "src/test/scala/MathSpec.scala", SymbolKind::Method,
            vec![], vec![], None, true,
        ),
        // Scala: testX prefix (MUnit convention)
        (
            "scala", "testComputation", "src/main/scala/Math.scala", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        // Scala: regular function outside test path, no test prefix
        (
            "scala", "compute", "src/main/scala/Math.scala", SymbolKind::Function,
            vec![], vec![], None, false,
        ),

        // --- Elixir: test_ prefix, test path, or "test " prefix ---
        (
            "elixir", "test_addition", "test/math_test.exs", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        // Elixir: in test/ directory (any function)
        (
            "elixir", "setup_context", "test/support/helpers.exs", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        // Elixir: "test " prefix (ExUnit macro naming)
        (
            "elixir", "test greets the world", "lib/my_app.ex", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        // Elixir: regular function outside test path
        (
            "elixir", "add", "lib/math.ex", SymbolKind::Function,
            vec![], vec![], None, false,
        ),

        // --- C#: attribute-driven ---
        (
            "csharp", "ShouldWork", "Tests/MyTest.cs", SymbolKind::Method,
            vec![], vec![s("Fact")], None, true,
        ),
        (
            "csharp", "ShouldAlsoWork", "Tests/MyTest.cs", SymbolKind::Method,
            vec![], vec![s("Theory")], None, true,
        ),
        // C#: bracketed attribute format
        (
            "csharp", "ShouldValidate", "Tests/MyTest.cs", SymbolKind::Method,
            vec![], vec![s("[Fact]")], None, true,
        ),
        // C#: no test attribute → false
        (
            "csharp", "ProcessOrder", "MyProject/OrderService.cs", SymbolKind::Method,
            vec![], vec![], None, false,
        ),

        // --- Razor: routes to C# detector ---
        (
            "razor", "ShouldRender", "MyProject.Tests/ButtonTests.cshtml", SymbolKind::Method,
            vec![], vec![s("Fact")], None, true,
        ),
        (
            "razor", "OnGet", "MyProject/Pages/Index.cshtml", SymbolKind::Method,
            vec![], vec![], None, false,
        ),

        // --- Go: Test/Fuzz/Example prefix AND _test.go file ---
        (
            "go", "TestParseInput", "parser/parser_test.go", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        (
            "go", "FuzzParse", "parser/parser_test.go", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        (
            "go", "ExampleParse", "parser/parser_test.go", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        // Go: Test prefix but NOT _test.go → false
        (
            "go", "TestParseInput", "parser/parser.go", SymbolKind::Function,
            vec![], vec![], None, false,
        ),
        // Go: _test.go but no recognized prefix → false
        (
            "go", "helperSetup", "parser/parser_test.go", SymbolKind::Function,
            vec![], vec![], None, false,
        ),

        // --- JavaScript: test/it/describe in test file ---
        (
            "javascript", "test", "src/__tests__/auth.test.js", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        (
            "javascript", "it", "tests/payment.test.js", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        (
            "javascript", "describe", "tests/payment.test.js", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        // JS: test function NOT in test file → false
        (
            "javascript", "test", "src/utils.js", SymbolKind::Function,
            vec![], vec![], None, false,
        ),

        // --- TypeScript: same rules as JS ---
        (
            "typescript", "describe", "src/payment.spec.ts", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        (
            "typescript", "test", "src/utils.ts", SymbolKind::Function,
            vec![], vec![], None, false,
        ),

        // --- PHP: @test doc or test prefix in test path ---
        (
            "php", "itShouldProcess", "tests/PaymentTest.php", SymbolKind::Method,
            vec![], vec![], Some("/** @test */"), true,
        ),
        (
            "php", "testProcessPayment", "tests/PaymentTest.php", SymbolKind::Method,
            vec![], vec![], None, true,
        ),
        // PHP: @test works even outside test path
        (
            "php", "someMethod", "src/Service.php", SymbolKind::Method,
            vec![], vec![], Some("/** @test */"), true,
        ),
        // PHP: test prefix in prod code → false (path guard)
        (
            "php", "testConnection", "src/database.php", SymbolKind::Method,
            vec![], vec![], None, false,
        ),

        // --- Ruby: test_ prefix AND test/spec path ---
        (
            "ruby", "test_process_payment", "spec/payment_spec.rb", SymbolKind::Method,
            vec![], vec![], None, true,
        ),
        (
            "ruby", "test_login", "test/auth_test.rb", SymbolKind::Method,
            vec![], vec![], None, true,
        ),
        // Ruby: test_ prefix but NOT in test path → false
        (
            "ruby", "test_connection", "lib/database.rb", SymbolKind::Method,
            vec![], vec![], None, false,
        ),

        // --- Swift: test prefix + test path ---
        (
            "swift", "testLogin", "Tests/AuthTests.swift", SymbolKind::Method,
            vec![], vec![], None, true,
        ),
        // Swift: setUp lifecycle in test path
        (
            "swift", "setUp", "Tests/AuthTests.swift", SymbolKind::Method,
            vec![], vec![], None, true,
        ),
        // Swift: test prefix NOT in test path → false
        (
            "swift", "testConnection", "Sources/App/DB.swift", SymbolKind::Method,
            vec![], vec![], None, false,
        ),

        // --- Dart: @isTest decorator or test prefix in test path ---
        (
            "dart", "myTest", "test/widget_test.dart", SymbolKind::Function,
            vec![s("isTest")], vec![], None, true,
        ),
        (
            "dart", "testWidgetRendering", "test/widget_test.dart", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        // Dart: test prefix in prod code → false (path guard)
        (
            "dart", "testWidgetRendering", "lib/widgets.dart", SymbolKind::Function,
            vec![], vec![], None, false,
        ),

        // --- Generic fallback: test_/Test prefix + test path ---
        (
            "lua", "test_something", "tests/test_util.lua", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        (
            "zig", "TestAllocator", "tests/allocator_test.zig", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        // Generic: test_ prefix but NOT in test path → false
        (
            "lua", "test_helper", "src/utils.lua", SymbolKind::Function,
            vec![], vec![], None, false,
        ),
        // Unknown language falls through to generic
        (
            "brainfuck", "test_something", "tests/test.bf", SymbolKind::Function,
            vec![], vec![], None, true,
        ),
        (
            "brainfuck", "run_program", "src/main.bf", SymbolKind::Function,
            vec![], vec![], None, false,
        ),

        // --- is_callable gate: non-callable kinds always return false ---
        (
            "rust", "TestFixture", "src/tests/foo.rs", SymbolKind::Struct,
            vec![], vec![s("test")], None, false,
        ),
        (
            "python", "TestPaymentProcessor", "tests/test_payment.py", SymbolKind::Class,
            vec![], vec![], None, false,
        ),
        (
            "java", "TestStatus", "src/test/java/Status.java", SymbolKind::Enum,
            vec![s("Test")], vec![], None, false,
        ),
        (
            "csharp", "ITestService", "Tests/ITestService.cs", SymbolKind::Interface,
            vec![], vec![s("Fact")], None, false,
        ),
        (
            "javascript", "test", "src/__tests__/payment.test.js", SymbolKind::Variable,
            vec![], vec![], None, false,
        ),
        // Constructor IS callable
        (
            "csharp", "TestSetup", "MyProject.Tests/Setup.cs", SymbolKind::Constructor,
            vec![], vec![s("TestMethod")], None, true,
        ),
    ];
